...
class PokemonTableSeeder extends Seeder {
	public function run()
	{
		...
		$pokemon->evolve_level = 17;
		$pokemon->base_hp = 9;
		$pokemon->base_attack = 10;
		$pokemon->base_sp_attack = 10;
		$pokemon->base_defense = 5;
		$pokemon->base_sp_defense = 5;
		$pokemon->base_speed = 11;
		...
		$pokemon->evolve_level = 34;
		$pokemon->base_hp = 94;
		$pokemon->base_attack = 27;
		$pokemon->base_sp_attack = 27;
		$pokemon->base_defense = 22;
		$pokemon->base_sp_defense = 22;
		$pokemon->base_speed = 28;
		...
		$pokemon->base_hp = 7;
		$pokemon->base_attack = 5;
		$pokemon->base_sp_attack = 5;
		$pokemon->base_defense = 4;
		$pokemon->base_sp_defense = 4;
		$pokemon->base_speed = 8;
